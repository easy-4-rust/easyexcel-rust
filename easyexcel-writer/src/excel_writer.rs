...
use easyexcel_core::util::work_book_util::create_sheet;
use easyexcel_core::{
...
use crate::csv_encoding_writer::CsvEncodingWriter;
use crate::excel_output_stream::ExcelOutputStream;
...
use crate::metadata::write_table::WriteTable as MirroredWriteTable;
...
use crate::write_sheet::WriteSheet;
...
pub struct ExcelWriter {
    ...
    pub(crate) gzip_spills: HashMap<String, crate::gzip_spill::GzipSheetDataWriter>,
