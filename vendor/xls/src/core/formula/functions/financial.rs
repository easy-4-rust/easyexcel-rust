...
fn euroconvert(_: &mut dyn Context, args: &[Value]) -> Value {
    ...
    let source = match &args[1] {
        ...
        v => match crate::core::formula::coerce::to_text(v) {
            Ok(s) => s,
            Err(e) => return err(e),
        },
    };
...
mod tests {
    ...
    fn test_irr_basic() {
        ...
        let r = irr(
            &mut ctx,
            &[Value::Array(crate::core::formula::value::Array::from_rows(
                vec![vec![
    ...
    fn test_irr_error_no_sign_change() {
        ...
        let r = irr(
            &mut ctx,
            &[Value::Array(crate::core::formula::value::Array::from_rows(
                vec![vec![Value::Number(100.0), Value::Number(200.0)]],
            ))],
        );
    ...
    fn test_mirr_basic() {
        ...
        let r = mirr(
            &mut ctx,
            &[
                Value::Array(crate::core::formula::value::Array::from_rows(vec![cfs])),
                Value::Number(0.10),
                Value::Number(0.12),
            ],
        );
    ...
    fn test_fvschedule() {
        ...
        let r = fvschedule(
            ...
            &[
                Value::Number(100.0),
                Value::Array(crate::core::formula::value::Array::from_rows(vec![vec![
                    Value::Number(0.09),
                    Value::Number(0.11),
                    Value::Number(0.1),
                ]])),
    ...
    fn ds(y: i32, m: u32, d: u32) -> Value {
        let serial = crate::core::dates::ymd_to_serial(DateSystem::Date1900, y, m, d).unwrap();
        Value::Number(serial)
    }
