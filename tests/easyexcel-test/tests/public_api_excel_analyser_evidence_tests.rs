...
-> easyexcel::Result<()> {
    ...
    assert_eq!(
        easyexcel::context::AnalysisContextLifecycle::analysis_context_impl(&xls_context)
            .excel_type(),
        ExcelTypeEnum::Xls
    );
    ...
    assert_eq!(
        easyexcel::context::AnalysisContextLifecycle::analysis_context_impl(&xlsx_context)
            .excel_type(),
        ExcelTypeEnum::Xlsx
    );
