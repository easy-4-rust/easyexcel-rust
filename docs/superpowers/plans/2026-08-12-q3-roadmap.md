...
|--------|--------|-------:|--------:|----------|
| ① 迁移 gap 闭环 | `docs/superpowers/plans/2026-08-12-migration-gap-closure.md` | 31 | 116 | parity 门禁全绿、84 unmapped + 479 ambiguous 清零、9 测试类移植 |
| ② 事件读追上 Java 吞吐 | `docs/superpowers/plans/2026-08-12-performance-optimization.md` | 13 | 73 | 205K → 307K+ rows/s、benchmark 基线入库、cross_runtime gate 落地 |
| ③ 补测试盲区 | `docs/superpowers/plans/2026-08-12-coverage-improvement.md` | 42 | 44.6 | ExcelRows/Fill executor 单测、Web conformance 7→42、parity 证据 26→100+ |
| ④ 恒定内存与写优化 | `docs/superpowers/plans/2026-08-12-write-optimization.md` | 8 + 2 RFC | 15.5 | 样式去重 O(n)→O(1)、状态机文档、读 spill/公式缓存 RFC |
...
- **文件**：[`docs/superpowers/plans/2026-08-12-migration-gap-closure.md`](migration/ROADMAP-gap-closure.md)
...
- **文件**：[`docs/superpowers/plans/2026-08-12-performance-optimization.md`](performance/EVENT-READ-OPTIMIZATION.md)
...
### ③ 补测试盲区（42 任务，44.6h）
- **文件**：[`docs/superpowers/plans/2026-08-12-coverage-improvement.md`](test/COVERAGE-GAP-CLOSURE.md)
...
- **文件**：[`docs/superpowers/plans/2026-08-12-write-optimization.md`](performance/WRITE-CONSTANT-MEMORY-OPTIMIZATION.md)
- **RFC 1**：[`docs/superpowers/specs/2026-08-12-read-spill-decision-design.md`](performance/READ-CONSTANT-MEMORY-RFC.md)——推荐不做 spill，改做包级惰性加载
- **RFC 2**：[`docs/superpowers/specs/2026-08-12-formula-cache-decision-design.md`](performance/FORMULA-RESULT-CACHE-RFC.md)——短期维持全量重算，中长期评估 dirty-cell 增量
