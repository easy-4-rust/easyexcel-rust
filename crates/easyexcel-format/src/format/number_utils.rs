...
/// 按 Java `BigDecimal#toBigInteger` 语义截断小数部分。
#[must_use]
...
/// 按 Java `Double#toString` 规则渲染有限值、零、无穷与 NaN。
#[must_use]
