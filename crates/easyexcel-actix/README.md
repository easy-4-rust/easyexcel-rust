...
`easyexcel` provides `ExcelRow`, `Format` and typed spreadsheet semantics; this adapter provides Actix Web transport integration. Keep both on the same release line.
