//! 对应 Java：`com.alibaba.excel.converters.bigdecimal.BigDecimalNumberConverter`.
//!
/// 对应 Java：`BigDecimalNumberConverter`.
...
impl crate::Converter<bigdecimal::BigDecimal> for BigDecimalNumberConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::converters::number_support::read_number(context)
    }
    ...
    fn convert_to_excel_data(
        ...
        crate::converters::number_support::write_number(context)
    }
}
