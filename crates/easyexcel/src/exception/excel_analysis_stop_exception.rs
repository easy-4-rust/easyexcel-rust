...
pub struct ExcelAnalysisStopException {
...
impl std::fmt::Display for ExcelAnalysisStopException {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        std::fmt::Display::fmt(&self.inner, f)
    }
}
impl std::error::Error for ExcelAnalysisStopException {}
impl From<ExcelAnalysisStopException> for crate::ExcelError {
    fn from(v: ExcelAnalysisStopException) -> Self {
