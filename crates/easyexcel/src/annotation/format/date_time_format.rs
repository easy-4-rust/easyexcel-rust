...
impl DateTimeFormat {
    ...
    /// 返回日期窗口三态开关。
    #[must_use]
    pub const fn use_1904windowing(&self) -> BooleanEnum { self.use_1904windowing }
    /// 设置日期窗口三态开关。
    pub const fn set_use_1904windowing(&mut self, value: BooleanEnum) { self.use_1904windowing = value; }
    /// 转换为写入/读取引擎属性。
    #[must_use]
