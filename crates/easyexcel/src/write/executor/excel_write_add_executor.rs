...
use crate::write::metadata::collection_row_data::CollectionRowData;
use crate::write::metadata::map_row_data::MapRowData;
use crate::write::write_progress::WriteProgress;
use crate::write::xlsx_write::write_xlsx;
...
mod tests {
    ...
    fn add_one_row_and_basic_type_write_cells() {
        ...
        crate::write::save_workbook(&mut workbook, &path, None).expect("save");
