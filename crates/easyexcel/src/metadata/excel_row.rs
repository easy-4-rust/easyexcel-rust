...
use crate::core::excel_write_metadata::ExcelWriteMetadata;
...
pub trait ExcelRow: Sized {
    ...
    fn to_row(&self) -> Result<Vec<crate::core::cell_value::CellValue>>;
    ...
    ) -> Result<Vec<crate::core::cell_value::CellValue>> {
        self.to_row()
    }
