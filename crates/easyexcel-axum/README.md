...
`easyexcel` provides `ExcelRow`, `Format` and typed spreadsheet semantics; this adapter provides Axum transport integration. Keep both on the same release line.
