...
[dependencies]
easyexcel = "0.1.2"
easyexcel-poem = "0.1.2"
```

`easyexcel` provides `ExcelRow`, `Format` and typed spreadsheet semantics; this adapter provides Poem transport integration. Keep both on the same release line.
