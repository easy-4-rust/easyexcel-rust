...
fn write_java_composite_fixture(path: &Path) -> Result<()> {
    write_compressed_java_fixture(
        path,
        include_str!("../../easyexcel-test/tests/fixtures/java-fixtures/java-demo-composite.xlsx.gz.b64"),
    )
}
...
fn fills_java_official_simple_template_with_typed_number() -> Result<()> {
    ...
    write_compressed_java_fixture(
        &template,
        include_str!("../../easyexcel-test/tests/fixtures/java-fixtures/java-demo-simple.xlsx.gz.b64"),
    )?;
...
fn java_complex_fill_with_table_appends_summary_after_repeated_fill() -> Result<()> {
    ...
    write_compressed_java_fixture(
        &template,
        include_str!("../../easyexcel-test/tests/fixtures/java-fixtures/java-demo-complex-fill-with-table.xlsx.gz.b64"),
    )?;
