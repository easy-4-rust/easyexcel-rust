...
#[allow(unused_imports)]
use crate::core::metadata::{CellRange, RowHeightProperty};
#[allow(unused_imports)]
use crate::core::{
...
#[allow(unused_imports)]
use crate::writer::handler_execution_scope::load_annotation_handlers;
#[allow(unused_imports)]
use crate::writer::shared_write_handler::SharedWriteHandler;
...
impl WriteHandler for OverrideAnnotationDimensions {
    fn order(&self) -> i32 {
        crate::core::constant::order_constant::DEFINE_STYLE
    }
...
fn live_holder_converter_map_matches_sheet_and_table_write_precedence() -> Result<()> {
    ...
    let mut table = crate::writer::metadata::WriteTable::with_table_no(2);
    table
        .options
        .converters
...
fn sheet_then_table_deduplicates_the_same_absolute_merge() -> Result<()> {
    ...
    writer.write_with_table(
        ...
        &sheet,
        &crate::writer::metadata::WriteTable::with_table_no(2),
    )?;
    writer.finish()?;
