...
pub struct WriteWorkbook {
    ...
    pub excel_type: crate::core::support::ExcelTypeEnum,
...
impl WriteWorkbook {
    ...
    pub fn new() -> Self {
        Self {
            ...
            excel_type: crate::core::support::ExcelTypeEnum::Xlsx,
            output_file: None,
        }
    }
    ...
    #[must_use]
    pub fn excel_type(&self) -> crate::core::support::ExcelTypeEnum {
        self.excel_type
    }

    /// Sets the Excel file type. (Java `setExcelType(ExcelTypeEnum)`)
    pub fn set_excel_type(&mut self, excel_type: crate::core::support::ExcelTypeEnum) -> &mut Self {
...
impl From<WriteOptions> for WriteWorkbook {
    fn from(options: WriteOptions) -> Self {
        let excel_type = options
            .excel_type
            .unwrap_or(crate::core::support::ExcelTypeEnum::Xlsx);
        Self {
            options,
            excel_type,
            output_file: None,
