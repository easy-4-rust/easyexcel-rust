...
pub use crate::core::event::NotRepeatExecutor;
pub use crate::core::metadata::csv::{CsvSheet, CsvWorkbook};
pub use crate::core::util::work_book_util::{
...
use crate::writer::append_rows::append_rows_to_worksheet_with_gzip_and_context;
use crate::writer::biff8::{
...
use crate::writer::creators::{
    Biff8RowCreator, XlsxCell, XlsxRowCreator, XlsxSheetCreator, XlsxWorkBookCreator,
};
use crate::writer::handler_execution_scope::HandlerExecutionScope;
use crate::writer::image_layout::ImageLayout;
use crate::writer::shared_write_handler::StatefulSheetState;
use crate::writer::sheet_style_context::{CellFormatContext, SheetStyleContext};

pub use crate::writer::append_rows::{
    append_rows_to_worksheet, append_rows_to_worksheet_with_gzip,
};
pub use crate::writer::excel_writer::ExcelWriter;

pub use crate::writer::builder::abstract_excel_writer_parameter_builder::AbstractExcelWriterParameterBuilder;
pub use crate::writer::builder::excel_writer_table_builder::ExcelWriterTableBuilder;
pub use crate::writer::cell_style::CellStyle;
pub use crate::writer::csv_encoding_writer::{
    CsvEncoding, CsvEncodingWriter, csv_bom, csv_encoding,
};
pub use crate::writer::excel_builder::{
    ExcelBuilder, ExcelBuilderImpl, FillConfig as BuilderFillConfig,
};
pub use crate::writer::excel_output_stream::ExcelOutputStream;
pub use crate::writer::executor::abstract_excel_write_executor::AbstractExcelWriteExecutor;
pub use crate::writer::executor::excel_write_add_executor::ExcelWriteAddExecutor;
pub use crate::writer::executor::excel_write_executor::ExcelWriteExecutor;
pub use crate::writer::executor::excel_write_fill_executor::ExcelWriteFillExecutor;
pub use crate::writer::global_configuration::{
    apply_global_configuration_to_write_options, global_configuration_from_write_options,
};
pub use crate::writer::gzip_spill::{GZIP_MAGIC, GzipSpillSnapshot, file_has_gzip_magic};
#[allow(deprecated)]
pub use crate::writer::handler::abstract_cell_write_handler::AbstractCellWriteHandler;
#[allow(deprecated)]
pub use crate::writer::handler::abstract_row_write_handler::AbstractRowWriteHandler;
#[allow(deprecated)]
pub use crate::writer::handler::abstract_sheet_write_handler::AbstractSheetWriteHandler;
#[allow(deprecated)]
pub use crate::writer::handler::abstract_workbook_write_handler::AbstractWorkbookWriteHandler;
pub use crate::writer::handler::cell_write_handler::CellWriteHandler;
pub use crate::writer::handler::default_write_handler_loader::DefaultWriteHandlerLoader;
pub use crate::writer::handler::r#impl::impl_default_row_write_handler::{
    DefaultRowWriteHandler, new_default_row_write_handler,
};
pub use crate::writer::handler::r#impl::impl_dimension_workbook_write_handler::DimensionWorkbookWriteHandler;
pub use crate::writer::handler::r#impl::impl_fill_style_cell_write_handler::FillStyleCellWriteHandler;
pub use crate::writer::handler::row_write_handler::RowWriteHandler;
pub use crate::writer::handler::sheet_write_handler::SheetWriteHandler;
pub use crate::writer::handler::workbook_write_handler::WorkbookWriteHandler;
pub use crate::writer::holder::abstract_write_holder::AbstractWriteHolder;
pub use crate::writer::holder::write_holder::WriteHolder;
pub use crate::writer::holder::write_sheet_holder::WriteSheetHolder as MirroredWriteSheetHolder;
pub use crate::writer::holder::write_table_holder::WriteTableHolder as MirroredWriteTableHolder;
pub use crate::writer::holder::write_workbook_holder::WriteWorkbookHolder as MirroredWriteWorkbookHolder;
pub use crate::writer::horizontal_alignment::HorizontalAlignment;
pub use crate::writer::merge::abstract_merge_strategy::AbstractMergeStrategy;
pub use crate::writer::merge::loop_merge_strategy::LoopMergeStrategy as MirroredLoopMergeStrategy;
pub use crate::writer::merge::once_absolute_merge_strategy::OnceAbsoluteMergeStrategy;
pub use crate::writer::merge::once_absolute_merge_strategy::OnceAbsoluteMergeStrategy as MirroredOnceAbsoluteMerge;
pub use crate::writer::merge_range::MergeRange;
pub use crate::writer::metadata::collection_row_data::CollectionRowData;
pub use crate::writer::metadata::map_row_data::MapRowData;
pub use crate::writer::metadata::row_data::RowData as MirroredRowData;
use crate::writer::metadata::style::write_cell_style::merge_write_cell_style;
use crate::writer::metadata::style::write_font::merge_excel_font_style as merge_handler_font_style;
pub use crate::writer::metadata::style::write_font::{
    excel_font_style_from_write_font, merge_excel_font_style, merge_write_font,
};
pub use crate::writer::metadata::write_basic_parameter::WriteBasicParameter as MirroredWriteBasicParameter;
pub use crate::writer::metadata::write_sheet::WriteSheet as MirroredWriteSheet;
pub use crate::writer::metadata::write_table::WriteTable as MirroredWriteTable;
pub use crate::writer::metadata::write_workbook::WriteWorkbook as MirroredWriteWorkbook;
pub use crate::writer::property::excel_write_head_property::ExcelWriteHeadProperty;
pub use crate::writer::style::abstract_cell_style_strategy::AbstractCellStyleStrategy;
pub use crate::writer::style::abstract_vertical_cell_style_strategy::AbstractVerticalCellStyleStrategy;
pub use crate::writer::style::column::longest_match_column_width_style_strategy::LongestMatchColumnWidthStyleStrategy;
pub use crate::writer::style::column::simple_column_width_style_strategy::SimpleColumnWidthStyleStrategy;
pub use crate::writer::style::default_style::DefaultStyle;
pub use crate::writer::style::horizontal_cell_style_strategy::HorizontalCellStyleStrategy;
pub use crate::writer::style::row::simple_row_height_style_strategy::SimpleRowHeightStyleStrategy;
pub use crate::writer::style::vertical_cell_style_strategy::VerticalCellStyleStrategy;
pub use crate::writer::vertical_alignment::VerticalAlignment;
pub use crate::writer::write::builder::excel_writer_builder::ExcelWriterBuilder as CompatibleExcelWriterBuilder;
pub use crate::writer::write::builder::excel_writer_builder::ExcelWriterOutputStreamBuilder as CompatibleExcelWriterOutputStreamBuilder;
pub use crate::writer::write::builder::excel_writer_sheet_builder::ExcelWriterSheetBuilder as CompatibleExcelWriterSheetBuilder;
pub use crate::writer::write_options::WriteOptions;
pub use crate::writer::write_progress::WriteProgress;
pub use crate::writer::write_sheet::WriteSheet;
...
pub(crate) fn with_default_write_converters(options: &WriteOptions) -> WriteOptions {
    ...
    effective.converters =
        crate::core::converter::default_converter_loader::load_default_write_converter()
    ...
    I: IntoIterator<Item = T>,
{
    ...
    let bytes = crate::writer::template_write::load_template_bytes(
        options.template_file.as_deref(),
        options.template_bytes.as_deref(),
    )?;
    if !crate::writer::biff8::looks_like_xls(&bytes) {
        return Err(ExcelError::Format(
            "xls with_template requires an OLE .xls workbook".to_owned(),
        ));
    }
    let mut package = crate::writer::biff8::Biff8TemplatePackage::from_bytes(&bytes)?;
    let sheet_names = package.sheet_names();
    let (target_index, target_name, create_new) =
        crate::writer::template_write::resolve_package_target(
            &sheet_names,
            options.sheet_index,
            &options.sheet_name,
        );
    ...
    I: IntoIterator<Item = T>,
{
    let mut spill = if options.compress_temp_files {
        Some(crate::writer::gzip_spill::GzipSheetDataWriter::create_owned(&options.sheet_name)?)
    } else {
        None
    };
...
pub(crate) fn write_sheet_to_workbook_with_gzip<T, I>(
    ...
    rows: I,
    handlers: &mut [Box<dyn WriteHandler>],
    gzip_spill: Option<&mut crate::writer::gzip_spill::GzipSheetDataWriter>,
...
where
    ...
    I: IntoIterator<Item = T>,
{
    crate::writer::template_write::validate_template_source(
        options.template_file.as_deref(),
        options.template_bytes.as_deref(),
    )?;
    let bytes = crate::writer::template_write::load_template_bytes(
    ...
    let mut package = crate::writer::template_write::TemplatePackage::from_bytes(&bytes)?;
    let sheet_names = package.sheet_names()?;
    let (target_index, target_name, create_new) =
        crate::writer::template_write::resolve_package_target(
            &sheet_names,
...
pub(crate) fn template_append_cell_styles<T>(
    package: &mut crate::writer::template_write::TemplatePackage,
    options: &WriteOptions,
    handlers: &[Box<dyn WriteHandler>],
...
pub(crate) fn save_template_package(
    package: &crate::writer::template_write::TemplatePackage,
    path: &Path,
    output: Option<&mut (dyn Write + Send)>,
    password: Option<&str>,
) -> Result<()> {
    ...
    I: IntoIterator<Item = T>,
{
    ...
    let sheets = crate::writer::template_write::load_template_sheets(&bytes)?;
    let (target_index, target_name, create_new) =
        crate::writer::template_write::resolve_template_target(
            &sheets,
            options.sheet_index,
            &options.sheet_name,
        );
    crate::writer::template_write::seed_workbook_from_template(workbook, &sheets)?;
    ...
    let mut spill = if write_options.compress_temp_files {
        Some(crate::writer::gzip_spill::GzipSheetDataWriter::create_owned(&target_name)?)
    } else {
        None
    };
...
pub(crate) fn begin_row_lifecycle(
    ...
    crate::core::util::write_handler_utils::before_row_create(handlers, context)?;
    crate::core::util::write_handler_utils::after_row_create(handlers, context)?;
    Ok(())
}
...
pub(crate) fn finish_row_lifecycle(
    ...
    crate::core::util::write_handler_utils::after_row_dispose(handlers, context)
}
...
pub(crate) fn begin_cell_lifecycle(
    ...
    crate::core::util::write_handler_utils::before_cell_create(handlers, context)?;
    context.apply_cell_mutations();
    crate::core::util::write_handler_utils::after_cell_create(handlers, context)?;
    context.apply_cell_mutations();
    crate::core::util::write_handler_utils::after_cell_data_converted(handlers, context)?;
    context.apply_cell_mutations();
...
pub(crate) fn finish_cell_lifecycle(
    ...
    crate::core::util::write_handler_utils::after_cell_dispose(handlers, context)
}
...
pub(crate) fn before_workbook(
    ...
    crate::core::util::write_handler_utils::before_workbook_create(handlers, context)
}
...
pub(crate) fn after_workbook_create(
    ...
    crate::core::util::write_handler_utils::after_workbook_create(handlers, context)
}
...
pub(crate) fn after_workbook(
    ...
    crate::core::util::write_handler_utils::after_workbook_dispose(handlers, context)
}
...
pub(crate) fn before_sheet(
    ...
    crate::core::util::write_handler_utils::before_sheet_create(handlers, context)
}
...
pub(crate) fn after_sheet_create(
    ...
    crate::core::util::write_handler_utils::after_sheet_create(handlers, context)
}
...
mod missing_tests;
pub use crate::writer::write_csv::*;
#[cfg(test)]
// Re-exports for tests
pub use crate::writer::write_xls::*;
pub use crate::writer::xlsx_write::*;
...
mod tests_extra {
    ...
    impl WriteHandler for NegativeMergeHandler {
        fn style_once_absolute_merge(
            &self,
        ) -> Option<crate::core::metadata::property::OnceAbsoluteMergeProperty> {
    ...
    impl crate::core::event::NotRepeatExecutor for UniqueHandler {
    ...
    impl WriteHandler for UniqueHandler {
        fn as_not_repeat_executor(&self) -> Option<&dyn crate::core::event::NotRepeatExecutor> {
            Some(self)
        }
    }
    ...
    fn finish_gzip_spill_failure_propagates() -> Result<()> {
        ...
        let mut spill = crate::writer::gzip_spill::GzipSheetDataWriter::create_owned("Sheet1")?;
    ...
    fn xlsx_public_write_with_template_bytes() -> Result<()> {
        ...
        crate::writer::xlsx_write::write_xlsx::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "pub")])],
        )?;
    ...
    fn xls_public_write_with_template_bytes() -> Result<()> {
        ...
        crate::writer::write_xls::write_xls::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "pub")])],
        )?;
    ...
    fn xls_public_write_to_writer_with_template() -> Result<()> {
        ...
        let mut output = Vec::new();
        crate::writer::write_xls::write_xls_to_writer::<DynamicRow, _, _>(
    ...
    fn xlsx_template_public_rejects_xls_template_file() -> Result<()> {
        ...
        let result = crate::writer::xlsx_write::write_xlsx::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "x")])],
        );
    ...
    fn xls_public_template_with_handlers_to_subdirectory() -> Result<()> {
        ...
        crate::writer::write_xls::write_xls_with_handlers::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "nested")])],
            &mut handlers,
    ...
    fn xlsx_template_annotation_merge_and_width_handlers() -> Result<()> {
        ...
        crate::writer::xlsx_write::write_xlsx_with_handlers::<AbsoluteMergeRow, _>(
            &path,
            &options,
            [AbsoluteMergeRow::new(vec![
                CellValue::String("l".to_owned()),
    ...
    fn sort_handlers_dedupes_repeat_executors() -> Result<()> {
        ...
        crate::writer::xlsx_write::write_xlsx_with_handlers::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "dedupe")])],
            &mut handlers,
    ...
    fn xlsx_template_to_writer_with_password() -> Result<()> {
        let mut output = Vec::new();
        crate::writer::xlsx_write::write_xlsx_to_writer::<DynamicRow, _, _>(
    ...
    fn table_annotation_handlers_second_write_short_circuits() -> Result<()> {
        ...
        let mut writer = ExcelWriter::new(&path);
        let sheet = WriteSheet::<TwoColRow>::new("Sheet1");
        let table = crate::writer::metadata::write_table::WriteTable::new();
    ...
    fn xls_write_with_automatic_merge_head_disabled() -> Result<()> {
        ...
        crate::writer::write_xls::write_xls::<TwoColRow, _>(
            &path,
            &options,
            [TwoColRow::new("a", "b")],
        )?;
    ...
    fn template_append_cell_styles_head_with_unknown_column() -> Result<()> {
        ...
        let mut package = crate::writer::template_write::TemplatePackage::from_bytes(
...
mod tests_extra2 {
    ...
    fn public_xls_template_missing_file_rejected() -> Result<()> {
        ...
        let result = crate::writer::write_xls::write_xls::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "v")])],
        );
    ...
    fn public_xls_template_handler_callback_error_propagates() -> Result<()> {
        ...
        let mut handlers: Vec<Box<dyn WriteHandler>> =
            vec![Box::new(StageFailingHandler(FailStage::DataCell))];
        let result = crate::writer::write_xls::write_xls_with_handlers::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "v")])],
            &mut handlers,
    ...
    fn public_xlsx_template_handler_callback_error_propagates() -> Result<()> {
        ...
        let mut handlers: Vec<Box<dyn WriteHandler>> =
            vec![Box::new(StageFailingHandler(FailStage::DataCell))];
        let result = crate::writer::xlsx_write::write_xlsx_with_handlers::<DynamicRow, _>(
            &path,
            &options,
            [dyn_row(&[(0, "v")])],
            &mut handlers,
    ...
    fn public_xlsx_legacy_seed_row_conversion_error_propagates() -> Result<()> {
        ...
        let result =
            crate::writer::xlsx_write::write_xlsx::<FailingRow2, _>(&path, &options, [FailingRow2]);
        assert!(matches!(result, Err(ExcelError::Data { .. })));
        Ok(())
    }
    ...
    fn template_layout_skips_explicit_column_widths() -> Result<()> {
        ...
        crate::writer::xlsx_write::write_xlsx::<PlainRow, _>(
            &path,
            &options,
            [PlainRow::new("a", "b")],
        )?;
    ...
    fn xlsx_comment_with_invalid_image_errors() -> Result<()> {
        ...
        let result = crate::writer::xlsx_write::write_xlsx::<DynamicRow, _>(&path, &options, [row]);
        assert!(matches!(result, Err(ExcelError::Format(_))));
        Ok(())
    }
...
mod tests_extra3 {
    ...
    impl crate::core::event::NotRepeatExecutor for UniqueHandler3 {
        fn unique_value(&self) -> &str {
            self.0
        }
    }
    ...
    fn xls_write_head_cell_failure_propagates() -> Result<()> {
        ...
        let result = crate::writer::write_xls::write_xls_with_handlers::<SingleColRow3, _>(
            &path,
            &WriteOptions::default(),
            [SingleColRow3 {
    ...
    fn template_package_from_bytes_rejects_garbage() {
        let result =
            crate::writer::template_write::TemplatePackage::from_bytes(b"not a zip package");
        assert!(matches!(result, Err(ExcelError::Format(_))));
    }
    ...
    fn xls_to_writer_template_failing_row() {
        ...
        let result = crate::writer::write_xls::write_xls_to_writer::<FailingRow3, _, _>(
            std::path::Path::new("logical.xls"),
            &mut output,
            &options,
            [FailingRow3],
    ...
    fn xlsx_legacy_seed_spill_failing_row() -> Result<()> {
        ...
        let result =
            crate::writer::xlsx_write::write_xlsx::<FailingRow3, _>(&path, &options, [FailingRow3]);
        assert!(matches!(result, Err(ExcelError::Data { .. })));
        Ok(())
    }
    ...
    fn xls_nested_dir_handlers_failing_row() -> Result<()> {
        ...
        let result = crate::writer::write_xls::write_xls_with_handlers::<FailingRow3, _>(
            &path,
            &WriteOptions::default(),
            [FailingRow3],
            &mut handlers,
    ...
    fn xlsx_template_annotation_merge_failing_row() -> Result<()> {
        ...
        let result = crate::writer::xlsx_write::write_xlsx_with_handlers::<FailingRow3, _>(
            &path,
            &options,
            [FailingRow3],
            &mut handlers,
    ...
    fn xlsx_template_password_failing_row() {
        ...
        let result = crate::writer::xlsx_write::write_xlsx_to_writer::<FailingRow3, _, _>(
            std::path::Path::new("logical.xlsx"),
            &mut output,
            &options,
            [FailingRow3],
