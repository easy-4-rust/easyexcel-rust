...
use crate::core::event::NotRepeatExecutor;
use crate::core::{
...
impl WriteHandler for SharedWriteHandler {
    ...
    fn before_sheet_create(&mut self, context: &crate::core::WriteSheetContext) -> Result<()> {
        self.with_mut(|handler| handler.before_sheet_create(context))
    }

    fn after_sheet_create(&mut self, context: &crate::core::WriteSheetContext) -> Result<()> {
        self.with_mut(|handler| handler.after_sheet_create(context))
    }

    fn after_sheet_dispose(&mut self, context: &crate::core::WriteSheetContext) -> Result<()> {
        self.with_mut(|handler| handler.after_sheet_dispose(context))
    }

    fn before_row_create(&mut self, context: &crate::core::WriteRowContext) -> Result<()> {
        self.with_mut(|handler| handler.before_row_create(context))
    }

    fn after_row_create(&mut self, context: &crate::core::WriteRowContext) -> Result<()> {
        self.with_mut(|handler| handler.after_row_create(context))
    }

    fn after_row_dispose(&mut self, context: &crate::core::WriteRowContext) -> Result<()> {
    ...
    fn style_cell_style(&self, context: &WriteCellContext) -> Option<crate::core::ExcelCellStyle> {
    ...
    fn style_loop_merge(
        &self,
    ) -> Option<(crate::core::metadata::property::LoopMergeProperty, usize)> {
