...
use crate::writer::holder::abstract_write_holder::AbstractWriteHolder;
use crate::writer::metadata::WriteBasicParameter;
...
mod tests {
    ...
    use super::*;
    use crate::writer::WriteHolder;
    use crate::writer::holder::write_sheet_holder::WriteSheetHolder;
    use crate::writer::holder::write_workbook_holder::WriteWorkbookHolder;
...
mod tests_extra {
    ...
    fn table_holder_deref_mut_reaches_abstract_holder() {
        use crate::writer::holder::write_holder::WriteHolder;
        let mut holder = WriteTableHolder::new(0);
        holder.set_excel_write_head_property(ExcelWriteHeadProperty::new());
        let target: &mut crate::writer::holder::abstract_write_holder::AbstractWriteHolder =
            &mut holder;
