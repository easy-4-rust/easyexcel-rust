...
use crate::writer::sheet_style_context::SheetStyleContext;
...
///
/// Java mapping: when `compress_temp_files` is on, [`crate::writer::gzip_spill::GzipSheetDataWriter`]
...
pub(crate) fn append_rows_to_worksheet_with_gzip_and_context<T, I>(
    ...
    write_head: bool,
    metadata: &ExcelWriteMetadata,
    mut gzip_spill: Option<&mut crate::writer::gzip_spill::GzipSheetDataWriter>,
