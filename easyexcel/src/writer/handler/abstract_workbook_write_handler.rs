//! 对应 Java：`com.alibaba.excel.write.handler.AbstractWorkbookWriteHandler`.

use crate::core::WriteHandler;

use crate::writer::handler::workbook_write_handler::WorkbookWriteHandler;

/// 对应 Java：`AbstractWorkbookWriteHandler implements WorkbookWriteHandler`.
#[allow(dead_code)]
