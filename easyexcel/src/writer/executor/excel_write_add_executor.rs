...
use crate::writer::append_rows::append_rows_to_worksheet;
use crate::writer::executor::abstract_excel_write_executor::AbstractExcelWriteExecutor;
use crate::writer::metadata::collection_row_data::CollectionRowData;
use crate::writer::metadata::map_row_data::MapRowData;
use crate::writer::write_progress::WriteProgress;
use crate::writer::xlsx_write::write_xlsx;
...
mod tests {
    ...
    use crate::core::{WriteContext, WriteContextHolder};
    ...
    impl WriteContextHolder for TestWriteContext {
        ...
        fn holder_type(&self) -> crate::core::Holder {
            crate::core::Holder::Workbook
        }

        fn excel_write_head_property(&self) -> &crate::core::ExcelWriteHeadProperty {
            static PROPERTY: std::sync::OnceLock<crate::core::ExcelWriteHeadProperty> =
                std::sync::OnceLock::new();
            PROPERTY.get_or_init(crate::core::ExcelWriteHeadProperty::new)
        }

        fn converter_map(&self) -> &crate::core::ConverterRegistry {
            static REGISTRY: std::sync::OnceLock<crate::core::ConverterRegistry> =
                std::sync::OnceLock::new();
            REGISTRY.get_or_init(crate::core::ConverterRegistry::default)
        }
    ...
    fn add_one_row_and_basic_type_write_cells() {
        ...
        crate::writer::save_workbook(&mut workbook, &path, None).expect("save");
    ...
    fn test_write_context_holder_surface_contract() {
        ...
        assert_eq!(context.holder_type(), crate::core::Holder::Workbook);
        assert!(
            context
