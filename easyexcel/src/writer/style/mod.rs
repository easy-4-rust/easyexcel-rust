//! 对应 Java：`com.alibaba.excel.write.style.*`.
//!
//! ## Wiring status (annotation metadata vs registered strategies)
//!
//! Annotation-driven styles on [`crate::core::ExcelWriteMetadata`] /
//! [`crate::core::ExcelColumn`] (via `#[derive(ExcelRow)]`) **are** consumed
...
//! [`crate::core::WriteHandler`] `style_*` accessors:
//!
