...
use crate::core::constant::builtin_format_code;
use crate::core::metadata::format::{
...
use crate::reader::analysis::v07::handlers::cell_formula_tag_handler::CellFormulaTagHandler;
use crate::reader::analysis::v07::handlers::cell_inline_string_value_tag_handler::CellInlineStringValueTagHandler;
use crate::reader::analysis::v07::handlers::cell_tag_handler::CellTagHandler;
use crate::reader::analysis::v07::handlers::cell_value_tag_handler::CellValueTagHandler;
use crate::reader::analysis::v07::handlers::count_tag_handler::CountTagHandler;
use crate::reader::analysis::v07::handlers::hyperlink_tag_handler::HyperlinkTagHandler;
use crate::reader::analysis::v07::handlers::merge_cell_tag_handler::MergeCellTagHandler;
use crate::reader::analysis::v07::handlers::row_tag_handler::RowTagHandler;
use crate::reader::analysis::v07::handlers::sax::shared_strings_table_handler::{
    SharedStringsTableHandler, local_tag, utf_decode,
};
use crate::reader::analysis::v07::handlers::xlsx_tag_handler::XlsxTagHandler;
use crate::reader::cache::resolve_read_cache_mode;
#[cfg(test)]
...
impl XlsxRowMetadata {
    ...
    pub(crate) fn extras(
        ...
        if enabled.contains(&crate::core::CellExtraType::Comment)
...
fn parse_worksheet_extras(
    ...
    let mut merge_handler =
        MergeCellTagHandler::new(enabled.contains(&crate::core::CellExtraType::Merge));
    let mut hyperlink_handler =
        HyperlinkTagHandler::new(enabled.contains(&crate::core::CellExtraType::Hyperlink));
    let mut buffer = Vec::with_capacity(256);
    loop {
        buffer.clear();
        match reader.read_event_into(&mut buffer).map_err(format_error)? {
    ...
    loop {
        ...
        match reader.read_event_into(&mut buffer).map_err(format_error)? {
            ...
            Event::End(element) if element.local_name().as_ref() == b"comment" => {
                ...
                extras.push(crate::core::CellExtra::new(
...
fn read_shared_strings<R: Read + Seek>(
    ...
    let selector = options
        .read_cache_selector
        .as_ref()
        .map(|stored| stored as &dyn crate::reader::cache::ReadCacheSelector);
...
/// [`CountTagHandler`](crate::reader::analysis::v07::handlers::count_tag_handler::CountTagHandler)
