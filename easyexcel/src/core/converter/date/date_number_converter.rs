//! 对应 Java：`com.alibaba.excel.converters.date.DateNumberConverter`.
//!
//! Rust maps Java `java.util.Date` to [`crate::JavaDate`].

/// 对应 Java：`DateNumberConverter`.
...
impl crate::Converter<crate::JavaDate> for DateNumberConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::core::converter::date_support::read_datetime(context).map(crate::JavaDate::new)
    }
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::WriteCellData::new(crate::CellValue::Float(
            crate::core::converter::date_support::datetime_to_excel_serial(
