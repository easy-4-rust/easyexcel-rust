//! 对应 Java：`com.alibaba.excel.converters.localdate.LocalDateStringConverter`.
//!
/// 对应 Java：`LocalDateStringConverter`.
...
impl crate::Converter<chrono::NaiveDate> for LocalDateStringConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::core::converter::date_support::read_date(context)
    }
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::core::converter::date_support::write_date_string(
            *context.value(),
            context,
        ))
    }
