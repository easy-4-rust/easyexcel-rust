//! 对应 Java：`com.alibaba.excel.converters.localdate.LocalDateNumberConverter`.
//!
/// 对应 Java：`LocalDateNumberConverter`.
...
impl crate::Converter<chrono::NaiveDate> for LocalDateNumberConverter {
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::WriteCellData::new(crate::CellValue::Float(
            crate::core::converter::date_support::date_to_excel_serial(
                *context.value(),
