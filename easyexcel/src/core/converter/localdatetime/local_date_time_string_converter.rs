//! 对应 Java：`com.alibaba.excel.converters.localdatetime.LocalDateTimeStringConverter`.
//!
/// 对应 Java：`LocalDateTimeStringConverter`.
...
impl crate::Converter<chrono::NaiveDateTime> for LocalDateTimeStringConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::core::converter::date_support::read_datetime(context)
    }
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::core::converter::date_support::write_datetime_string(
            *context.value(),
            context,
        ))
    }
