//! 对应 Java：`com.alibaba.excel.converters.booleanconverter.BooleanNumberConverter`.
//!
/// 对应 Java：`BooleanNumberConverter`.
...
impl crate::Converter<bool> for BooleanNumberConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::core::converter::boolean_support::read_number_boolean(context)
    }
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::core::converter::boolean_support::write_boolean_number(context))
    }
}
