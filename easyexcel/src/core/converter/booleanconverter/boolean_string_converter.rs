//! 对应 Java：`com.alibaba.excel.converters.booleanconverter.BooleanStringConverter`.
//!
/// 对应 Java：`BooleanStringConverter`.
...
impl crate::Converter<bool> for BooleanStringConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::core::converter::boolean_support::read_string_boolean(context)
    }
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::core::converter::boolean_support::write_boolean_string(context))
    }
}
