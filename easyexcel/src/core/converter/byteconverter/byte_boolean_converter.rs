//! 对应 Java：`com.alibaba.excel.converters.byteconverter.ByteBooleanConverter`.
//!
/// 对应 Java：`ByteBooleanConverter`.
...
mod tests_extra {
    ...
    fn writes_one_as_true_and_zero_as_false() {
        // 对应 Java：`ByteBooleanConverter` 按 1 / 0 写出布尔单元格
        let converter = ByteBooleanConverter;
