//! 对应 Java：`com.alibaba.excel.converters.string.StringBooleanConverter`.
//!
/// 对应 Java：`StringBooleanConverter`.
...
impl crate::Converter<String> for StringBooleanConverter {
    ...
    fn convert_to_rust_data(
        ...
        crate::core::converter::boolean_support::read_boolean_string_value(context)
    }
    ...
    fn convert_to_excel_data(
        ...
        Ok(crate::core::converter::boolean_support::write_string_boolean(context))
    }
}
