...
impl crate::Converter<String> for StringNumberConverter {
    ...
    fn convert_to_rust_data(
        ...
        {
            if crate::core::util::date_utils::is_internal_date_format(pattern) {
                return crate::core::converter::date_support::format_number_as_datetime_string(
                    context, pattern,
                );
            }
            return crate::core::util::number_utils::format_decimal(
                &decimal,
                decimal < 0,
                Some(pattern),
